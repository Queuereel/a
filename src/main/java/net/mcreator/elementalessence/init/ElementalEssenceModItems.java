...
import net.mcreator.elementalessence.item.EmperHeartItem;
...
public class ElementalEssenceModItems {
	...
	public static final RegistryObject<Item> EMPER_HEART = REGISTRY.register("emper_heart", () -> new EmperHeartItem());
}
